...
module "tse_controlplane" {
  ...
  tetrate_helm_version             = coalesce(var.tetrate_helm_version, var.tetrate_version)
  tetrate_managementplane_host     = data.terraform_remote_state.tse_managementplane.outputs.tetrate_managementplane_hostname output_path                      = var.output_path
